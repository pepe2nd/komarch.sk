  ...
  >
    ...
    <table class="hidden lg:table w-full text-left">
      <thead>
        <tr>
          <th>
            <ButtonSortable :value="getSortDirectionFor('announced_at')" @input="setSort('announced_at', $event)"
              style="min-width: 200px" class="pb-10 text-sm">
      ...
      <tbody class="text-sm">
        ...
        >
          <td class="py-1">
            ...
            <span v-else>{{ __('contests.in_verification') }}</span>
          </td>
          <td class="py-1">
