<template>
  <label class="py-1 flex group cursor-pointer hover:text-blue">
    <input
      type="checkbox"
      v-bind="$attrs"
      :value="option.key"
      :checked="isChecked"
      class="cursor-pointer mt-1 h-4 w-4 border border-black rounded-md bg-white checked:bg-black appearance-none focus:outline-none group-hover:border-blue group-hover:border-2"
      @change="onChange"
    >
    <span class="ml-2">
